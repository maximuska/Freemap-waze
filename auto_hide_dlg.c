...
void auto_hide_dlg(PFN_ON_DIALOG_CLOSED cbOnClosed){
   ...
   container = ssd_container_new(AH_CONT_NAME, NULL, SSD_MIN_SIZE, SSD_MIN_SIZE, SSD_ROUNDED_CORNERS|SSD_ROUNDED_WHITE|SSD_CONTAINER_BORDER);

   box = ssd_container_new ("Resume", NULL, SSD_MAX_SIZE, 45, SSD_END_ROW|SSD_WS_TABSTOP);
   ssd_widget_set_color(box, NULL, NULL);
   ssd_widget_add(box, ssd_text_new ("ResumeTxt", roadmap_lang_get("Resume manually"), 16, SSD_END_ROW|SSD_WIDGET_SPACE|SSD_ALIGN_VCENTER|SSD_ALIGN_CENTER));
   ...
   box = ssd_container_new ("Resume30", NULL, SSD_MAX_SIZE, 45, SSD_END_ROW|SSD_WS_TABSTOP);
   ssd_widget_set_color(box, NULL, NULL);
   ssd_widget_add(box, ssd_text_new ("Resume30Txt", roadmap_lang_get("Resume in 30 seconds"), 16, SSD_END_ROW|SSD_WIDGET_SPACE|SSD_ALIGN_VCENTER|SSD_ALIGN_CENTER));
   ssd_widget_add(box, ssd_separator_new("Separator",SSD_ALIGN_BOTTOM));
   box->callback = auto_hide_dlg_callback ;
   ssd_widget_set_pointer_force_click( box );
   box->pointer_down = on_pointer_down;
   ...
   box = ssd_container_new ("Exit", NULL, SSD_MAX_SIZE, 45, SSD_END_ROW|SSD_WS_TABSTOP);
   ssd_widget_set_color(box, NULL, NULL);
   ssd_widget_add(box, ssd_text_new ("ExitTxt", roadmap_lang_get("Quit"), 16, SSD_END_ROW|SSD_WIDGET_SPACE|SSD_ALIGN_VCENTER|SSD_ALIGN_CENTER));
   ssd_widget_add(box, ssd_separator_new("Separator",SSD_ALIGN_BOTTOM));
   box->callback = auto_hide_dlg_callback ;
   ssd_widget_set_pointer_force_click( box );
   box->pointer_down = on_pointer_down;
   ...
   box = ssd_container_new ("Cancel", NULL, SSD_MAX_SIZE, 45, SSD_END_ROW|SSD_WS_TABSTOP);
   ssd_widget_set_color(box, NULL, NULL);
   ssd_widget_add(box, ssd_text_new ("CancelTxt", roadmap_lang_get("Cancel"), 16, SSD_END_ROW|SSD_WIDGET_SPACE|SSD_ALIGN_VCENTER|SSD_ALIGN_CENTER));
   box->callback = auto_hide_dlg_callback ;
   ssd_widget_set_pointer_force_click( box );
   box->pointer_down = on_pointer_down;
   ssd_widget_add(container, box);
