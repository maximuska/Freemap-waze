...
const char* Hebrew_Disclaimer2 =
         "1. קראת והנך מסכים לתנאי השימוש ומדיניות הפרטיות כמו שמפורטים באתר www.waze.co.il\r\n\r\n" \
         "2. השימוש בשירות הינו באחריותך בלבד. יכולות המיקום של התכנה אינן מדויקות לחלוטין\r\n\r\n";
const char* Hebrew_Disclaimer3 =
         "3. שירות waze הינו חינם, אך מצריך חיבור לרשת לצורך קבלת עדכונים בזמן אמת. המפעיל הסלולרי שלך עשוי לחייב אותך בגין תעבורת רשת.\r\nאנא וודא שהנך מנוי לחבילה המתאימה\r\n\r\n" \
         "4. תוכנת waze הינו מוצר קוד פתוח \r\n (תחת רשיון  GPL V.2)  המבוסס על מידע ותוכן הנוצר ע\"י משתמשים ומיועד לשימוש פרטי ולא מסחרי בלבד\r\n\r\n";
const char* Hebrew_Disclaimer4 =
	     "5. חברת waze לא תחוב, באף נסיבות שהן, בגין נזקים מיוחדים, ישירים, עקיפים, אגביים, עונשיים או תוצאתיים הנובעים מהשימוש או מאי-יכולת לעשות"
	     " שימוש בשירות waze, לרבות, ללא הגבלה, הנובעים מתאונות דרכים, קנסות או עונשי תנועה, מפות, נתוני מפות, נתיבים או הוראות בלתי נכונים, או הפעלת שירות waze במהלך נהיגה, אף אם waze קיבלה הודעה"
	     " בדבר האפשרות לנזקים כאמור";
...
const char* English_Disclaimer2 =
      ...
      "1. You have read and agree to the 'Terms of Use' and 'Privacy Policy' on www.waze.com\r\n\r\n";
const char* English_Disclaimer3 =
      "2. Your use of this real-time guidance application is at your sole risk. Never rely solely on the contents, materials and services provided by the product\r\n\r\n"
      "3. Your are aware that the installed product is an open-source (GPL Version 2) software using community generated content and data, intended for non-commercial and private use only\r\n\r\n";
const char* English_Disclaimer4 =
      "4. To the maximum extent permitted by applicable laws, waze excludes any and all responsibility and liability (including negligence), arising from or in connection to any use of this product and its contents";
