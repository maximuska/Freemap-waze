   ...
   switch (tab){
      ...
      case tab_traffic_jam:
         ...
         case tab_accidents:
            ...
            break;
         case tab_chit_chat:
            populate_tab(tab_chit_chat,5, RT_ALERT_TYPE_CHIT_CHAT, RT_ALERT_TYPE_HAZARD,RT_ALERT_TYPE_OTHER, RT_ALERT_TYPE_CONSTRUCTION, RT_ALERT_TYPE_PARKING);
            break;
...
RoadMapAction RoadMapAlertListActions[20] = {
   ...
   {"report_list_police", "Police", "Police", NULL,
      "Police", report_list_police},
...
void RealtimeAlertsList(){
  ...
  ssd_menu_set_right_text(ALERTS_LIST_TITLE, "report_list_other",count_tab(tab_chit_chat,5, RT_ALERT_TYPE_CHIT_CHAT, RT_ALERT_TYPE_HAZARD,RT_ALERT_TYPE_OTHER, RT_ALERT_TYPE_CONSTRUCTION, RT_ALERT_TYPE_PARKING));
#else
...
static int on_options(SsdWidget widget, const char *new_value, void *context)
{
   ...
   ssd_contextmenu_show_item( &context_menu,
                              ...
                              (g_list_sorted == sort_recency) && !is_empty && !is_auto_jam,
                              FALSE);
   ssd_contextmenu_show_item( &context_menu,
                              rtl_cm_sort_recency,
