...
//   // FOR_TESTING_ONLY
//   altRout->srcPosition.latitude = pos->latitude;
//   altRout->srcPosition.longitude = pos->longitude;
//   // FOR_TESTING_ONLY
   ...
   // FOR_TESTING_ONLY
//   NavigateRouteResult res[3];
//   res[0].description = "Test1";
//   res[0].total_length = 21000;
//   res[0].total_time = 3600;
//   res[1].description = "Test2";
//   res[1].total_length = 22000;
//   res[1].total_time = 3600;
//   res[2].description = "Test3";
//   res[2].total_length = 23000;
//   res[2].total_time = 3600;
//   RealtimeAltRoutes_OnRouteResults (route_succeeded, 3, &res[0]);
   // FOR_TESTING_ONLY
   kill_timer ();
...
void roadmap_alternative_routes_suggest_route_dialog () {
   ...
   dialog = ssd_dialog_new (ALT_ROUTE_SUGGEST_ROUTE_DLG_NAME, "", NULL, SSD_DIALOG_FLOAT
                  | SSD_ALIGN_CENTER | SSD_ROUNDED_CORNERS | SSD_CONTAINER_BORDER);
   ...
   for (i = 0; i < num_trips; i++) {
      ...
      if (!strcmp (roadmap_lang_get (altRout->sDestinationName), roadmap_lang_get ("Home"))) {
         bitmap_name = "home";
      }
      else if (!strcmp (roadmap_lang_get (altRout->sDestinationName), roadmap_lang_get ("Work"))) {
         bitmap_name = "work";
      }
      else {
...
//   position = malloc (sizeof(RoadMapPosition));
//   roadmap_check_allocated(position);
//   position->latitude = 32080794;
//   position->longitude = 34804828;
   //FOR_TESTING_ONLY
...
void roadmap_alternative_routes_init (void) {
  ...
  gLoginCallBack = Realtime_NotifyOnLogin (roadmap_alertnative_routes_after_login);
   ...
   //FOR_TESTING_ONLY
  //on_suggested_trips(14, "2728,Home,32080794,34804828,Home,32080794,34804828,2729,Gym,32080794,34804828, Gym,32080794,34804828" );
